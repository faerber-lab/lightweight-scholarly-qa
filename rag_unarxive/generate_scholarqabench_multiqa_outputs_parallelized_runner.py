...
generate_process = subprocess.Popen(["bash", "-c", f"source ~/.bashrc; set_capella_env && python -u generate_scholarqabench_multiqa_output.py --topk 10 --output_dir {generate_output_dir}{'' if USE_RAG else ' --no_rag'}"])
