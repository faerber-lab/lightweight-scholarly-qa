...
OUTPUT_BASE_DIR = "output_scholarqabench_multiqa/"
...
for i,run in enumerate(runs):
    ...
    generate_process = subprocess.Popen(["bash", "-c", f"source ~/.bashrc; set_capella_env && python generate_scholarqabench_multiqa_output.py --output_dir {generate_output_dir}{'' if run.use_rag else ' --no_rag'}"])
