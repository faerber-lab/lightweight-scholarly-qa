...
In this work, we investigate whether carefully designed retrieval pipelines can compensate for model scale. We introduce a lightweight retrieval-augmented framework for scholarly question answering that performs task-aware routing prior to retrieval, enabling more effective interaction with scientific literature using large language models.
